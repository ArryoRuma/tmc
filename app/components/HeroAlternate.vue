...
const props = withDefaults(defineProps<Props>(), {
  ...
  description: 'Transform your business with data-driven strategies that deliver measurable results and sustainable growth.',
...
<template>
  <section
    class="relative py-24 md:py-32 lg:py-40"
  ...
  >
    ...
    >
      <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-12 gap-4 items-center">
        <!-- Left Column -->
