...
// Note: Legal content is currently embedded in template. Consider moving to content/ for version control.
</script>
...
<template>
  <div>
    ...
    <UPageHero>
      <template #title>
        <h1 class="text-4xl sm:text-6xl font-bold text-highlighted">
          Privacy Policy
        </h1>
      </template>
    ...
    <UPageSection class="prose prose-lg max-w-4xl mx-auto">
      <div class="space-y-8">
        <div>
