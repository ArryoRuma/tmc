...
<template>
  <div>
    ...
    <UPageHero>
      <template #title>
        <h1 class="text-5xl sm:text-7xl text-pretty tracking-tight font-bold text-highlighted">
          ...
          <span class="text-primary block" style="font-family: 'new-spirit', serif !important; font-weight: 700 !important;">
            Amazing
          </span>
        </h1>
      </template>
    ...
    <UPageSection class="py-16">
      <div class="grid lg:grid-cols-2 gap-16">
        ...
        <div>
          ...
          <div v-if="isSubmitted" class="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6">
            <div class="flex items-center gap-3">
              <UIcon name="i-lucide-check-circle" class="text-green-600 text-xl" />
              <div>
                <h3 class="font-semibold text-green-800 dark:text-green-200">Thank you!</h3>
                <p class="text-green-700 dark:text-green-300 text-sm">We've received your message and will get back to you within 24 hours.</p>
              </div>
            </div>
          </div>
        ...
        <div class="space-y-8">
          <div>
            <h2 class="text-3xl font-bold text-highlighted mb-6">Contact Information</h2>
          ...
          <div class="bg-gradient-to-br from-primary/5 to-primary/10 border border-primary/20 rounded-xl p-6">
            <div class="flex items-center gap-3 mb-3">
              ...
              <h3 class="font-semibold text-highlighted">Quick Response Guarantee</h3>
            </div>
    ...
    >
      <template #links>
        <UButton size="lg" to="/pricing">
          View Our Services
        </UButton>
        <UButton size="lg" variant="outline" to="/portfolio">
          See Our Work
        </UButton>
      </template>
    </UPageCTA>
