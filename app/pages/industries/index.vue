...
const { data: page } = await useAsyncData("industries-index", () =>
  queryCollection("industriesIndex").first(),
);
    ...
    <FadeInUp :delay="0.3">
      <UContainer>
        <UPageSection
          ...
          description="Industry-specific expertise to help you achieve your business goals."
        >
          <UPageGrid>
            <FadeInUp
