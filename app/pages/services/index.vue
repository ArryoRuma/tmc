...
const { data: page } = await useAsyncData("services-index", () =>
  queryCollection("servicesIndex").first(),
);
  ...
  <div v-if="page?.title">
    ...
    <FadeInUp :delay="0.3">
      <UContainer>
        <UPageSection
          title="Our Services"
          description="Explore our comprehensive range of services designed to help you grow."
        >
          <UPageGrid>
            <FadeInUp
